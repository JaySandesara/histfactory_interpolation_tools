...
Build a library around Ambient Fisher and GP regression for regression using arbitrary (alpha, p(x|alpha)) pairs - regardless of whether they come from binned approximations or NN estimated PDFs.
